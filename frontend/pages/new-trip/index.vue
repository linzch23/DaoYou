        ...
        >
          ...
          <view class="action-row">
            ...
            <view
              ...
              @click="onConfirm"
            >
              <text class="btn-submit-text">{{ strings.btnConfirm }}</text>
            </view>
          </view>
        </view>
...
import _ErrorBanner from '../../components/_ErrorBanner.vue'
import _DraftConfirmDialog from './components/_DraftConfirmDialog.vue'
