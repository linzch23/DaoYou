<!--
  ...
  Spec contract: specs/EditTripPage.md §8.1
  ...
  注:
    - 与 NewTripPage 私有 _DraftConfirmDialog 形态完全一致(spec §10 R-3)
    - **不**抽到 components/ 跨页通用(MVP 唯一调用方,沿用 NewTripPage §8.1 同样决策)
    - storage key 隔离由 page 端保证(edit_trip_drafts vs trip_drafts),本组件**不**感知
