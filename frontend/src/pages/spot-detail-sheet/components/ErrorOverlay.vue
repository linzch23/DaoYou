<!--
  ErrorOverlay.vue — SpotDetailSheet 页面级错误兜底
  ...
  >
    <view class="error-overlay-inner">
      ...
      <view
        ...
        :class="{ 'error-overlay-button-disabled': isLocked }"
        role="button"
...
const props = defineProps({
   ...
   * 当父 page 处于飞行中(isRetrying=true)时,视觉 disabled + tap 屏蔽。
   */
  loading: {
    type: Boolean,
    default: false,
...
/**
 * 300ms 节流窗:防止父 onErrorAction 同步重入(per Throttle-001 §4.1 共享协议)
 */
