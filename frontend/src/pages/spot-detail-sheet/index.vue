<!--
  ...
  私有:pages/spot-detail-sheet/components/ErrorOverlay.vue(spec §3.3 / §8.2)
 ...
 * 错误兜底按钮点击节流锁(per issues/Cross-Page/Throttle-001 §4.2)
 * 0~10ms brief 窗口 + 1~3s async 段防双击堆叠,onUnmounted 兜底 reset
 */
 ...
 * spec §5.3.A / §5.3.C
 * Throttle-001 §4.2:retry 分支加 isRetrying 互斥锁(共享组件 + 局部双重保护)
 */
